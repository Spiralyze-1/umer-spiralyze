...
(function () {
  ...
  function hasAbandonFormCookie2033() {
    if (getCookieEarly("spz-2033-v1-closed") || getCookieEarly("spz-2033-v1-submitted")) return false;
...
const bodyInterval2033 = setInterval(function () {
  if (document.querySelector("body") && !document.querySelector("spz_2033_v1")) {
    ...
    const canShowAbandonPopup = () => {
      ...
      if (get_cookie("spz-2033-v1-closed") || get_cookie("spz-2033-v1-submitted")) return false;
    ...
    const addModal = () => {
      if (!document.querySelector(".spz-2033-modal") && !get_cookie("spz-2033-v1-closed") && !get_cookie("spz-2033-v1-submitted")) {
