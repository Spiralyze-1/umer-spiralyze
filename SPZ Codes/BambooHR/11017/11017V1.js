(function() {
  const bodyInterval11017 = setInterval(function(){
    if(document.querySelector('body') && !document.querySelector('.spz_11017_v')){
      clearInterval(bodyInterval11017)
      const squeezePage = 'both'; // true / false / 'both'
      const expName = '11017'; //experiment name should be 1001, 1002, 1003 etc.
      ...
      ******************************/
      ...
      document.querySelector('body').classList.add("spz_11017_v");
      document.querySelector('body').insertAdjacentHTML("afterbegin",`
        <div class="spz-11017-header">
          <div class="wrapper">
            <a href="https://www.bamboohr.com/" class="spz11017_v logo">
              <picture>
            ...
            <a href="https://app.bamboohr.com/login/" class="spz11017_v login-button" >Log In</a>
          </div>
        </div>
        <div class="spz-11017-section1">
          <div class="wrapper">
            ...
            <div class="title">Time Tracking Software <br><span class="green">That Works The Way You Do</span></div>
            <div class="description">Bring time tracking, attendance, and time off together so you can reduce errors and save hours every week.</div>
            <button class="spz11017_v show-popup-button">Book a Demo</button>
            <picture class="hero-image">
              <source srcset="https://res.cloudinary.com/spiralyze/image/upload/f_auto/bamboohr/11017/hero_image__mobile.webp" media="(max-width: 767.98px)">
              <source srcset="https://res.cloudinary.com/spiralyze/image/upload/f_auto/bamboohr/11017/hero_image__tablet.webp" media="(max-width: 1199.98px)">
              <img src="https://res.cloudinary.com/spiralyze/image/upload/f_auto/bamboohr/11017/hero_image__desktop.webp" alt="Hero Image" width="1440" height="320">
              </picture>
          </div>
        </div>
        <div class="spz-11017-section2">
          <div class="wrapper">
            ...
            <div class="dynamic-logo">
              <section class="splide splide11017-section2">
          ...
          <div class="wrapper">
            ...
            <div class="review-wrapper">
              ...
              <div class="customer-review">
                <section class="splide splide11017-section7">
                  <div class="splide__track">
                    <ul class="splide__list">
                      <li class="splide__slide">
                        <div class="card">
        ...
        <div class="spz-11017-section9">
          <div class="wrapper">
            <div class="footer-wrapper desktop">
              <div class="left">
                <div class="links">
                  <div class="top">
                    <a class="spz11017_v" href="https://www.bamboohr.com/site-map">Site Map</a>
                    <a class="spz11017_v" href="/legal/security">Security</a>
                    <a class="spz11017_v" href="/legal/">Legal</a>
                    <a class="spz11017_v" href="/legal/">Privacy</a>
                    <a class="spz11017_v" id="cookie-preferences">Cookie Preferences</a>
                    <a class="spz11017_v" href="https://www.bamboohr.com/faq">FAQ</a>
                    <a class="spz11017_v" href="https://www.bamboohr.com/exp/refer-friend">Refer a Friend, Earn $200</a>
                  </div>
                  <div class="bottom">
                    <a class="spz11017_v" href="/legal/">Rewards Program Terms</a>  
                    <a class="spz11017_v" href="/legal/bamboohr-modern-slavery-statement.pdf">Modern Slavery Statement</a>  
                    <a class="spz11017_v" href="/legal/bamboohr-anti-bribery-statement.pdf">Anti-Bribery Statement</a>  
                    <a class="spz11017_v" href="https://documentation.bamboohr.com/docs/getting-started">API</a>  
                  </div>
                  <a class="donot">
              ...
              <div class="right">
                <div class="social-media">
                  <div>
                  <a class="spz11017_v" href="https://www.facebook.com/bamboohr/">
                  ...
                  <div>
                  <a class="spz11017_v" href="https://x.com/bamboohr/">
                  ...
                  <div>
                  <a class="spz11017_v" href="https://www.instagram.com/bamboohr/">
                  ...
                  <div>
                  <a class="spz11017_v" href="https://www.linkedin.com/company/bamboohr/">
                  ...
                  <div>
                  <a class="spz11017_v" href="https://www.youtube.com/user/bamboohr/">
            ...
            <div class="footer-wrapper tablet">
              ...
              <div class="links">
                <div class="top">
                  ...
                  <a class="spz11017_v" href="/legal/">Privacy</a>
                  <a class="spz11017_v" id="cookie-preferences">Cookie Preferences</a>
                  <a class="spz11017_v" href="https://www.bamboohr.com/ca/legal/rewards-program-terms">Rewards Program Terms</a>
                  </div>
                </div>
                <div class="donot">
                  Do not Sell or Share my Personal Information.
      ...
      const formInterval = setInterval(function(){
        if(document.querySelector('.form-col-container') && document.querySelector('.bhrForm__partnerDisclaimer') && document.querySelector('#LblEmployees_Text__c').closest('.mktoFormRow.form-input-width50')){
          ...
          document.querySelector('.spz_11017_v .form-container .form-col-container').insertAdjacentHTML("afterbegin",`<button class="spz11017_v close-button"></button>`)
      ...
      const footerLinkInterval = setInterval(function(){
        if(document.querySelector('footer .legal a')){
          ...
          document.querySelector('.spz-11017-section9 .links .donot').setAttribute('href', document.querySelector('footer .legal a').getAttribute('href'))
        }
      },60)
      // event listener click
      document.addEventListener('click', function(e){
        if(e.target.closest('.show-popup-button')){
          document.querySelector('html').classList.add('no-scroll')
          // 1. Show the popup container using your exact setup
          document.querySelector('.spz_11017_v .form-container').classList.add('show');

          const popup = document.querySelector('.spz_11017_v .form-container form');

          // 2. Make the form tag itself programmatically focusable
          popup.setAttribute('tabindex', '-1');
          popup.style.outline = 'none'; 
          popup.focus(); // Focuses the form wrapper silently

          // 3. Get all potential interactive items
          const focusableElementsString = 'button, [href], input, select, textarea, [tabindex]';
          const allElements = popup.querySelectorAll(focusableElementsString);

          // FIX: Filter out elements that are hidden, disabled, or explicitly skipped via tabindex="-1"
          ...
          if (focusableElements.length > 0) {
              ...
              // 4. Strict Tab key event listener bound directly to the form
              popup.addEventListener('keydown', function(e) {
                  if (e.key !== 'Tab') return; // Only intercept the Tab key

                  // If focus is sitting on the form wrapper itself, direct it into the inputs
                  ...
                  // Strict Focus Trap Boundaries
                  if (e.shiftKey) { // Shift + Tab (Navigating backward)
                      if (document.activeElement === firstFocusableElement) {
                          lastFocusableElement.focus(); 
                          e.preventDefault(); // Stop the browser from leaving the form
                      }
        ...
        if(e.target.closest('.spz11017_v.close-button')){
          document.querySelector('html').classList.remove('no-scroll')
          document.querySelector('.spz_11017_v .form-container').classList.remove('show')
        }
        if(e.target.closest('.spz-11017-section1 .tabs-wrapper-mobile .dropdown-content')){
          document.querySelector('.spz-11017-section1 .tabs-wrapper-mobile').classList.toggle('open')
        } else {
          document.querySelector('.spz-11017-section1 .tabs-wrapper-mobile').classList.remove('open')
        }
        if(e.target.closest('.spz-11017-section1 .tabs-wrapper-mobile .dropdown-choices .tab')){
          if(document.querySelector('.spz-11017-section1 .tabs-wrapper-mobile .dropdown-choices .tab.selected')){
            document.querySelector('.spz-11017-section1 .tabs-wrapper-mobile .dropdown-choices .tab.selected').classList.remove('selected')
          }
          e.target.closest('.spz-11017-section1 .tabs-wrapper-mobile .dropdown-choices .tab').classList.add('selected')
          document.querySelector('.spz-11017-section1 .tabs-wrapper-mobile .dropdown-content .top-text .selection').textContent=e.target.closest('.spz-11017-section1 .tabs-wrapper-mobile .dropdown-choices .tab').querySelector('span').textContent
        }
        if(e.target.closest('.spz-11017-section9 #cookie-preferences')){
          document.querySelector('#teconsent a').click()
        }
        const tab = e.target.closest('.spz-11017-section1 .tabs .tab, .spz-11017-section1 .dropdown-choices .tab');
        if (tab) {
          ...
          if (targetEl) {
            ...
            if(window.matchMedia("(min-width: 1199.98px)").matches){
              headerOffset = document.querySelector('.spz-11017-section1 .tabs-wrapper').offsetHeight;
            } else {
              headerOffset = document.querySelector('.spz-11017-section1 .tabs-wrapper-mobile').offsetHeight;
            }
      ...
      loadJS('https://cdn.jsdelivr.net/npm/@splidejs/splide@4.1.4/dist/js/splide.min.js', function(){
        var splide11017_2 = new Splide( '.splide11017-section2', {
          type   : 'loop',
          autoWidth: true,
          arrows: false,
          pagination: false,
        ...
        var splide11017_7 = new Splide( '.splide11017-section7', {
          type   : 'loop',
          pagination: false,
          interval: 4000,
          easing: 'linear',
      ...
      initStickyElement('.spz-11017-section1 .tabs-wrapper');
      initStickyElement('.spz-11017-section1 .tabs-wrapper-mobile');
      
      // carousel FAQ
      const closedCarouselAnimation = (curActiveElement)=>{
        const curHeight= document.querySelector('.spz-11017-section8 .carousel-wrapper .child[data-index="'+curActiveElement+'"]').offsetHeight;
        document.querySelector('.spz-11017-section8 .carousel-wrapper .child[data-index="'+curActiveElement+'"]').classList.remove("active")
        document.querySelector('.spz-11017-section8 .carousel-wrapper .child[data-index="'+curActiveElement+'"]').removeAttribute("style")
        const afterHeight = document.querySelector('.spz-11017-section8 .carousel-wrapper .child[data-index="'+curActiveElement+'"]').offsetHeight;
        document.querySelector('.spz-11017-section8 .carousel-wrapper .child[data-index="'+curActiveElement+'"]').style.height=curHeight+"px"
        setTimeout(function(){
          document.querySelector('.spz-11017-section8 .carousel-wrapper .child[data-index="'+curActiveElement+'"]').style.height=afterHeight+"px"
        },1)
        setTimeout(function(){
          document.querySelector('.spz-11017-section8 .carousel-wrapper .child[data-index="'+curActiveElement+'"]').removeAttribute("style")
        },501)
      ...
      const adjustContentHeight =()=>{
        const curActiveElementIndex = document.querySelector('.spz-11017-section8 .carousel-wrapper .child.active').getAttribute("data-index");
        const curActiveElement =document.querySelector('.spz-11017-section8 .carousel-wrapper .child[data-index="'+curActiveElementIndex+'"]');
      ...
      document.querySelector('.spz-11017-section8 .carousel-wrapper').addEventListener('click', function(e) {
        if(e.target.closest(".carousel-title") && !e.target.closest(".clicked")){
          //remove active
          const curActiveElement = document.querySelector('.spz-11017-section8 .carousel-wrapper .child.active').getAttribute("data-index");
          document.querySelector('.spz-11017-section8 .carousel-wrapper .child[data-index="'+curActiveElement+'"]').classList.remove("clicked");
  
          // to add animation when closed
          if(curActiveElement!=e.target.closest('.child').getAttribute("data-index")){
            // add tab index
            // remove  tabindex in  a ahref
            const allAHref=document.querySelectorAll('.spz-11017-section8 .carousel-wrapper .child[data-index="'+curActiveElement+'"] .carousel-content a');
          ...
          if(curActiveElement!=e.target.closest('.active').getAttribute("data-index")){
            // remove  tabindex in  a ahref
            const allAHref =document.querySelectorAll('.spz-11017-section8 .carousel-wrapper .child.active .carousel-content a[tabindex="-1"]');
            for(let i=0;i<allAHref.length;i++){
          ...
          if(window.matchMedia("(max-width: 1199.98px)").matches && document.querySelector('.spz-11017-section8 .carousel-wrapper .child.clicked')){
            setTimeout(function(){
