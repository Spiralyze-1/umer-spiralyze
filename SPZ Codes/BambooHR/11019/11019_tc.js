    ...
    if (pathname === '/pl-pages/hr-software') {
        if (document.querySelector('.spz_hero_banner h1')) {
            ...
            const heading = document.querySelector(
                '.spz_11012_v #base .section.quote-container .columns-wrapper.content-width-md h2#a-single-platform-where-everything-works-together'
            );
...
function secondSectionChanges() {
    ...
    const pageConfigs = {
        '/pl-pages/hr-software': {
            baseSelector: '.spz_11012_v #base .section.quote-container .columns-wrapper .columns.columns-2-cols',
            imageReplacements: [
                {
        ...
        '/pl-pages/hr-time-tracking': {
            baseSelector: '.spz_11012_v.hr-time-tracking #base .section.columns-container:not(.logos-container) .columns.columns-2-cols',
            imageReplacements: [
                {
        ...
        '/pl-pages/onboarding': {
            baseSelector: '.spz_11012_v.onboarding #base .section.quote-container .columns-wrapper .columns-2-cols:not(:has(#create-better-first-days-for-your-new-hires))',
            imageReplacements: [
                {
    ...
    const rightColImageInterval11012 = setInterval(function () {
        ...
        if (currentConfig.quoteImage) {
            const quotePicture = document.querySelector('.spz_11012_v #base .section.quote-container .quote-wrapper picture');
        ...
        if (pathname === '/pl-pages/hr-time-tracking') {
            // const integrationSection = document.querySelector('.spz_11012_v.hr-time-tracking #base .section.columns-container:not(.logos-container) .columns-wrapper:has(#simplify-overtime-tracking-and-reduce-compliance-risk)');
            ...
            if (currentConfig.quoteImage) {
                const quotePicture = document.querySelector('.spz_11012_v.hr-time-tracking #base .section.columns-container:not(.logos-container) .columns.testimonial picture');
                if (quotePicture && !quotePicture.hasAttribute('data-spz-replaced')) {
                    quotePicture.innerHTML = `<source media="(max-width: 768px)" srcset="${currentConfig.quoteImage.mobileSrc}">
                  <img src="${currentConfig.quoteImage.desktopSrc}" alt="${currentConfig.quoteImage.alt}">`;
                    quotePicture.setAttribute('data-spz-replaced', 'true');
            ...
            const column = document.querySelector(
                `.spz_11012_v.hr-time-tracking #base .section.columns-container.logos-container .columns.columns-2-cols .column5.non-img-col`
            );
        ...
        if (pathname === '/pl-pages/onboarding') {
            // const integrationSection = document.querySelector('.spz_11012_v.onboarding #base .section.quote-container .columns-wrapper:has(#save-timeand-the-environment)');
            // if (integrationSection && document.querySelectorAll('.integration-section').length === 0) {
            //     integrationSection.insertAdjacentHTML('afterend', `<div class="integration-section">
            //         <h3 id="integration-marketplace">Integration Marketplace</h3>
            //         <picture>
            ...
            const topColumnSection = document.querySelector('.spz_11012_v.onboarding #base .section.quote-container .columns-wrapper:has(#create-better-first-days-for-your-new-hires) .column5.non-img-col');
            ...
            if (currentConfig.quoteImage) {
                const quotePicture = document.querySelector('.spz_11012_v.onboarding #base .section.columns-container:not(.logos-container) .columns.testimonial picture');
                if (quotePicture && !quotePicture.hasAttribute('data-spz-replaced')) {
            ...
            const column = document.querySelector(
                `.spz_11012_v.onboarding #base .section.columns-container.logos-container .columns.columns-2-cols .column5.non-img-col`
            );
    ...
    if (document.querySelector('.logos-wrapper')) {
        document.querySelector('.logos-wrapper').insertAdjacentHTML('afterend', `
...
function tabSectionChanges() {
    ...
    const tabsWrapper = setInterval(function () {
        ...
        const baseSelector = '.spz_11012_v.onboarding .tabs-custom-wrapper .tabs-custom-content';
        let allFound = true;
...
function awardSection() {
    if (document.querySelectorAll('.spz_award_section').length === 0) {
        document.querySelector('.spz_11012_v #base .awards-container.reviews-container').insertAdjacentHTML('afterend', `<section class="spz_award_section">
 <div class="container">
    <ul>
       <li>
          <picture>
...
function footerChanges() {
    ...
    const footerLogoInterval = setInterval(function () {
        if (document.querySelectorAll('.spz_11012_v footer.footer-limited .brand .footer_logo').length === 0) {
            const brandElement = document.querySelector('.spz_11012_v footer.footer-limited .brand');
...
const tabSectionInterval = setInterval(function () {
    const tabChild = document.querySelectorAll('.spz_11012_v.onboarding .tabs-custom-wrapper .tabs-custom-content .child');

    if (tabChild.length === 4) {
        clearInterval(tabSectionInterval);

        const content = document.querySelector('.spz_11012_v.onboarding .tabs-custom-wrapper .tabs-custom-content');
...
const bodyInterval11012 = setInterval(function () {
    if (document.querySelector('body') && !document.querySelector('.spz_11012_v')) {
        clearInterval(bodyInterval11012)
        document.querySelector('body').classList.add("spz_11012_v");
        heroBannerChanges();
        setTimeout(() => {
        ...
        const variantName = expName + `_true_control`; //variantName should be _V1, _V2, _TC etc.
