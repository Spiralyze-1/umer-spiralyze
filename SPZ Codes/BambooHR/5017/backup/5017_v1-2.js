  ...
  if (!bodyEle.classList.contains('spz_5017_v')) {
    ...
    function replacePricingHeading() {
      ...
      if (headingEl) {
        ...
        if (target && target.innerHTML.trim() !== `<strong>Plans and pricing </strong> for every organization`) {
          target.innerHTML = `<strong>Plans and pricing </strong> for every organization`;
        }
      }
    }
    ...
    setTimeout(() => {
      ...
      if(document.querySelector('.spz_5017_v .section:has(#add-on-solutions) .cards-wrapper .cards .card:nth-child(3)')){
        document.querySelector('.spz_5017_v .section:has(#add-on-solutions) .cards-wrapper .cards .card:nth-child(3) #time--attendance').textContent = 'Time Tracking';
        document.querySelector('.spz_5017_v .section:has(#add-on-solutions) .cards-wrapper .cards .card:nth-child(3) >ul li:nth-child(6)').textContent = 'iPad Apps & Time Clocks';
      }
    }, 3000);
