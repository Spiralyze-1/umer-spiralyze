    ...
    <ul>
      <li>
        <div class="spz_slider_data">
          ...
          <div class="spz_slider_image"> 
            <picture>
              <source media="(max-width: 767px)" srcset="https://res.cloudinary.com/spiralyze/image/upload/f_auto/bamboohr/13018/f_auto_hr_data__reporting_image_mobile.webp">
              <img src="https://res.cloudinary.com/spiralyze/image/upload/f_auto/bamboohr/13018/f_auto_hr_data__reporting_image_desktop.webp" alt="HR Data & Reporting" loading="lazy" />
            </picture>
          </div>
        </div>
      </li>
      <li>
        <div class="spz_slider_data">
          ...
          <div class="spz_slider_image">
            <picture>
              <source media="(max-width: 767px)" srcset="https://res.cloudinary.com/spiralyze/image/upload/f_auto/bamboohr/13018/f_auto_hiring__onboarding.webp">
              <img src="https://res.cloudinary.com/spiralyze/image/upload/f_auto/bamboohr/13018/f_auto_hiring__onboarding_1.webp" alt="Hiring & Onboarding" loading="lazy"/>
            </picture>
          </div>
        </div>
      </li>
      <li>
        <div class="spz_slider_data">
          ...
          <div class="spz_slider_image">
            <picture>
              <source media="(max-width: 767px)" srcset="https://res.cloudinary.com/spiralyze/image/upload/f_auto/bamboohr/13018/f_auto_payroll_time__benefits_img_mobile.webp">
              <img src="https://res.cloudinary.com/spiralyze/image/upload/f_auto/bamboohr/13018/f_auto_payroll_time__benefits_img_desktop.webp" alt="Payroll, Time & Benefits" loading="lazy"/>
            </picture>
          </div>
        </div>
      </li>
      <li>
        <div class="spz_slider_data">
          ...
          <div class="spz_slider_image">
            <picture>
              <source media="(max-width: 767px)" srcset="https://res.cloudinary.com/spiralyze/image/upload/f_auto/bamboohr/13018/f_auto_employee_experience__performance_mobile.webp">
              <img src="https://res.cloudinary.com/spiralyze/image/upload/f_auto/bamboohr/13018/f_auto_employee_experience__performance_desktop.webp" alt="Employee Experience & Performance" loading="lazy"/>
            </picture>
          </div>
        </div>
      </li>
      <li>
        <div class="spz_slider_data">
          ...
          <div class="spz_slider_image">
            <picture>
              <source media="(max-width: 767px)" srcset="https://res.cloudinary.com/spiralyze/image/upload/f_auto/bamboohr/13018/f_auto_compensation_img_mobile.webp">
              <img src="https://res.cloudinary.com/spiralyze/image/upload/f_auto/bamboohr/13018/f_auto_compensation_img_desktop.webp" alt="Compensation" loading="lazy"/>
            </picture>
          </div>
        </div>
      </li> 
