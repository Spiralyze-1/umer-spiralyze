  ...
  const bodyInterval3019 = setInterval(function () {
    if (
      ...
      if (
        ...
        document.querySelector('.spz_3019_v').classList.add('search_smallBusiness')
        document.querySelector('.spz_3019_v .lp-header-wrapper').insertAdjacentHTML("afterbegin", heroHTML)
        document.querySelector('.spz_3019_v .spz-3010-section1 .wrapper .header a').removeAttribute("target")
        document.querySelector('.spz_3019_v .spz-3010-section1 .wrapper .header a').setAttribute("href", "https://www.lendio.com/lp/direct/search-small-business-loans")
        document.querySelector('.spz_3019_v .spz-3010-section1 .hero-section .text .eyelash').insertAdjacentHTML("beforeend", `
        <div class="tooltips">
        ...
        document
          .querySelector(".spz_3019_v .hero-section > .text")
    ...
    formIntervalTwo = setInterval(function () {
      if (document.querySelector('lendio-start') && document.querySelector('lendio-start').shadowRoot) {
        ...
        if (window.location.pathname == '/lp/direct/search-small-business-loans' && document.querySelector('.text-amount-form-wrap-var-2')) {
          document.querySelector('.spz_3019_v .spz-3010-section1 .hero-section .text .form-wrapper').insertAdjacentElement("beforeend", document.querySelector('.text-amount-form-wrap-var-2'))
        }
