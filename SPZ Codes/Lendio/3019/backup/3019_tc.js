(function () {
  ...
  const bodyInterval3008 = setInterval(function () {
    if (
      ...
      !document.querySelector(".spz_3008_v")
    ) {
        ...
        <div class="wrapper">
          ...
          <div class="hero-section">
            ...
            <div class="image lp-hero-img-col">
              <picture>
                <source media="(max-width:767.98px)" srcset="https://cdn.prod.website-files.com/67473c04b086bff6a8789185/69c4c8a80e201e457415ba53_0a8c21a0e5dab904caeca1bba0f95b7c_sba-loan-mobile.webp">
                <source media="(max-width:1024.98px)" srcset="https://cdn.prod.website-files.com/67473c04b086bff6a8789185/69c4c8a957bc7edbb2298f0b_d8163ea3bc57dce49815545461682662_sba-loan-tablet.webp">
                <img src="https://cdn.prod.website-files.com/67473c04b086bff6a8789185/69c4c8aaa97c99b30df8bd7e_ec46c6a390c0848b89f49dcb08048086_sba-loan-desktop.webp" width="566" height="563" alt="Hero Image">
              </picture>
            </div>
          </div>
        </div>
      ...
      if (
        ...
        document.querySelector(".spz_3008_v .lp-pwf-form-wrapper")
      ) {

        document.querySelector('.spz_3008_v').classList.add('search_smallBusiness')
        document.querySelector('.spz_3008_v .lp-header-wrapper').insertAdjacentHTML("afterbegin", heroHTML)
        document.querySelector('.spz_3008_v .spz-3010-section1 .wrapper .header a').removeAttribute("target")
        document.querySelector('.spz_3008_v .spz-3010-section1 .wrapper .header a').setAttribute("href", "https://www.lendio.com/lp/direct/search-small-business-loans")
        document.querySelector('.spz_3008_v .spz-3010-section1 .hero-section .text .eyelash').insertAdjacentHTML("beforeend", `
        <div class="tooltips">
        ...
        `)
        searchSmallBsuinessForm();

        document
          .querySelector(".spz_3008_v .hero-section > .text")
          .insertAdjacentHTML("beforeend", newHTMl);
        if (document.querySelectorAll(".back_btn").length === 0) {
          document
            .querySelector(".spz_3008_v .text-amount-form-wrap-var-2")
            .insertAdjacentHTML(
              "afterbegin",
        ...
        if (
          document.querySelector(
            ".spz_3008_v .spz-3010-section1 .wrapper .header a",
          )
        ) {
          document
            .querySelector(".spz_3008_v .spz-3010-section1 .wrapper .header a")
      ...
      if (
        ...
        document.querySelector(".spz_3008_v .lp-hero-content-wrapper")
      ) {
        document
          .querySelector(".spz_3008_v .lp-hero-content")
          .insertAdjacentHTML("beforeend", newHTMl);
        if (document.querySelectorAll(".back_btn").length === 0) {
          document
            .querySelector(".spz_3008_v .text-amount-form-wrap-lp-sbfv2")
            .insertAdjacentHTML(
              "afterbegin",
              '<div class="back_btn"><span>Back</span></div>',
            );
  ...
  function searchSmallBsuinessForm() {
    let formIntervalTwo;
    ...
    formIntervalTwo = setInterval(function () {
      if (document.querySelector('lendio-start') && document.querySelector('lendio-start').shadowRoot) {
        ...
        if (window.location.pathname == '/lp/direct/search-small-business-loans' && document.querySelector('.text-amount-form-wrap-var-2')) {
          document.querySelector('.spz_3008_v .spz-3010-section1 .hero-section .text .form-wrapper').insertAdjacentElement("beforeend", document.querySelector('.text-amount-form-wrap-var-2'))
        }
    ...
    function initCarouselObserver() {
      ...
      function syncHideBtn() {
        const backBtn = document.querySelector(
          ".spz_3008_v .text-amount-form-wrap-lp-sbfv2 .back_btn",
        );
        if (!backBtn) return;
