(function () {
  const bodyInterval3001 = setInterval(function () {
    if (document.body &&
      ...
      function otherPage() {
        const selectors = `
           .form-div-header .hs_cos_wrapper_type_inline_text,
           .form-div-header .form-h6-lp-spec,
           .form-heading-lp-spec .hs_cos_wrapper_type_inline_text,
           .form-heading-lp-spec .form-h6-lp-spec
        `;

        const elements = document.querySelectorAll(selectors);

        elements.forEach(el => {
          el.innerHTML = `LOAN QUALIFICATION  <div class="tooltips">
      ...
      if (window.location.pathname.includes('/sba-loans') || window.location.pathname.includes('/partners-sf') || window.location.pathname.includes('/small-business-financing') || window.location.pathname.includes('/partners-lf')) {
        ...
        <div class="form-div-header"><span class="col-10 px-0"><div id="hs_cos_wrapper_module_17050092700534" class="hs_cos_wrapper hs_cos_wrapper_widget hs_cos_wrapper_type_module" style="" data-hs-cos-general-type="widget" data-hs-cos-type="module"><div id="hs_cos_wrapper_module_17050092700534_" class="hs_cos_wrapper hs_cos_wrapper_widget hs_cos_wrapper_type_inline_text" style="" data-hs-cos-general-type="widget" data-hs-cos-type="inline_text" data-hs-cos-field="headline">LOAN QUALIFICATION  <div class="tooltips">
            <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" viewBox="0 0 17 17" fill="none">
              <path d="M8.125 15.625C12.2671 15.625 15.625 12.2671 15.625 8.125C15.625 3.98286 12.2671 0.625 8.125 0.625C3.98286 0.625 0.625 3.98286 0.625 8.125C0.625 12.2671 3.98286 15.625 8.125 15.625Z" stroke="#9C86BB" stroke-width="1.25" stroke-linecap="round" stroke-linejoin="round"></path>
              <path d="M7.5 7.5C7.66576 7.5 7.82473 7.56585 7.94194 7.68306C8.05915 7.80027 8.125 7.95924 8.125 8.125V11.25C8.125 11.4158 8.19085 11.5747 8.30806 11.6919C8.42527 11.8092 8.58424 11.875 8.75 11.875" stroke="#9C86BB" stroke-width="1.25" stroke-linecap="round" stroke-linejoin="round"></path>
              <path d="M7.8125 5.625C8.33027 5.625 8.75 5.20527 8.75 4.6875C8.75 4.16973 8.33027 3.75 7.8125 3.75C7.29473 3.75 6.875 4.16973 6.875 4.6875C6.875 5.20527 7.29473 5.625 7.8125 5.625Z" fill="#9C86BB"></path>
            </svg>
            <div class="text">
              Answer the basics about your business and what you're using your funding for. If you qualify, we'll match you with one of our 75+ lenders and find the right match for you.
            </div>
      ...
      function newSection() {
        ...
        if (window.location.pathname == '/lp/direct/search-small-business-loans' || window.location.pathname.includes('/partners-sf') || window.location.pathname.includes('/small-business-financing') || window.location.pathname.includes('/partners-lf')) {
          otherPage();
        }
      }
        ...
        formInterval = setInterval(function () {
          if (document.querySelector('lendio-start')) {
            if (document.querySelector('lendio-start').shadowRoot) {
              ...
              const tooltipText = document.querySelector('#pwf-1 div:has(.disclosure-tooltip) small');
              if (tooltipText) {
                const firstTextNode = tooltipText.childNodes[0];
