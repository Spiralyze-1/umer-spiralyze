function spz2009() {
    if (!document.querySelector('body').classList.contains('spz_2009_v')) {
        document.querySelector('body').classList.add('spz_2009_v');

        if (document.querySelector('.header-main .btn-header .btn')) {
            document.querySelector('.header-main .btn-header .btn').classList.add('spz_2009_v');
            document.querySelector('.header-main .btn-header .btn').textContent = "Get a demo";
        }
        widnow.addEventListener('click', function (e) {
            if (e.target.classList.contains('spz_2009_v') || (e.target.closest('.btn-header') && e.target.classList.contains('spz_2009_v'))) {
                e.prevenDefault();
                window.location.href = 'https://canoeintelligence.com/demo-request/';
            }
        });
...
(function () {
    ...
    const expName = '2009'; //experiment name should be 1001, 1002, 1003 etc.
