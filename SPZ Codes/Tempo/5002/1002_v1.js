(function () {
  ...
  function init1002() {
      ...
      const targetElement = document.querySelector(
          'body.spz_1002_v .spz_main_wrapper aside#formsignup'
      );
      if (targetElement) {
          const observer = new MutationObserver((mutations) => {
              mutations.forEach((mutation) => {
                  if (
                      ...
                      // Remove the style attribute as soon as it's added
          ...
          console.log('MutationObserver is watching for style attribute changes...');
      } else {
