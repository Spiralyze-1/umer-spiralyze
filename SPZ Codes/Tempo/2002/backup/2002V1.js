        ...
        const observer = new MutationObserver((mutationsList) => {
          ...
          if (document.querySelector('.spz_2002_v') && document.querySelector('.spz_2002_v main > div.light') && !document.querySelector('.spz_2002_v .section-1-2002')) {
                    ...
                    <div class="child" data-index="5">
                      ...
                      <div class="content">
                        ...
                        <div class="button-wrapper">
                          ...
                          <div class="mobile-image">
                            <picture>
                            <source media="(max-width:767.98px)" srcset="//res.cloudinary.com/spiralyze/image/upload/f_auto/tempo/2002/financial_management_tablet.webp">
                            <img src="//res.cloudinary.com/spiralyze/image/upload/f_auto/tempo/2002/financial_management_mobile.webp" alt="Financial management" title="Financial management" width="688" height="572" loading="lazy">
                          </picture>
                        </div>
                      </div>
                    </div>
            ...
            const playCarousel = () => {
              ...
              document.querySelector('.spz_2002_v .section-1-2002 .carousel-section .child[data-index="' + curActiveElement + '"] .bar .line').style.opacity = 1;
              ...
              carouselInterval = setInterval(function () {
                document.querySelector('.spz_2002_v .section-1-2002 .carousel-section .child[data-index="' + curActiveElement + '"] .bar .line').style.width = "" + ((i / time) * 100) + "%";
                // reach end
                if (i > time) {
                  clearInterval(carouselInterval)
