...
(function () {
  ...
  const expName = "2007";
  const variantName = `SPZ_#` + expName + `_variant`; // _variant, _true_control, etc.
  ...
  const config = {
    expName: expName,
    bodyClass: "spz_2007_v",
    backgroundVideo: "https://res.cloudinary.com/spiralyze/video/upload/v1785173342/greenlightguru/2007/greenlight-guru-2007.mp4",
        ...
        <div class="spz-container">
          <div class="content-left">
            <div class="content-left-outer">
              <h1 class="hero-title">Streamline quality management, <br>audits, and more</h1>
              ...
              <div class="hero-bottom">
                <div class="hero-stat">
                  <p class="stat-headline">Helped us pass our audit flawlessly</p>
                  <p class="stat-subtext">“Provides a team of medical device industry pros. Addresses dependencies across our quality system. Connects audits, CAPA, and change management. Provides everything our auditors need.’”</p>
                </div>
